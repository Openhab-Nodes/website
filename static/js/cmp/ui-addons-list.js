...
// (143:4) {#each seachresults as addon}
...
// (92:6) {#each often_installed as addon}
...
// (105:6) {#each recommended as addon}
...
// (127:8) {#each last_updated as addon}
function create_each_block(ctx) {
	var li, t0_value = ctx.addon.label + "", t0, t1, t2, br, t3, t4_value = new Date(ctx.addon.last_updated).toLocaleString() + "", t4, t5, t6_value = ctx.addon.version + "", t6, t7;
	...
	return {
		...
		p(changed, ctx) {
			if ((changed.last_updated) && t0_value !== (t0_value = ctx.addon.label + "")) {
