...
/* assets/js/ui-btn-logout/btn.svelte generated by Svelte v3.12.0 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			dispose = listen(button, "click", ctx.signout);
		},
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function start() {
    ...
    $$invalidate('disabled', disabled = false);
  }
  start();
  ...
  function signout() {
	...
	return { disabled, classes, signout };
}
...
window.customElements.define('ui-btn-logout', class extends HTMLElement {
    constructor() {
        super();
    }
    connectedCallback() {
...
//# sourceMappingURL=ui-btn-logout.js.map
