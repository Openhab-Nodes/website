...
var atobNormalized = typeof commonjsGlobal.atob === 'function' ? commonjsGlobal.atob : atob;
...
var polyfill = {
  atob: function (base64String) {
    return atobNormalized.call(commonjsGlobal, base64String);
  },
  _atob: atob
};
 ...
 */
BraintreeError.types = enumerate_1([
  'CUSTOMER',
  'MERCHANT',
  'NETWORK',
  'INTERNAL',
...
var braintreeError = BraintreeError;

var constants$1 = {
  BRAINTREE_VERSION: '2018-05-10'
};

var isIe11 = function isIe11(ua) {
  ua = ua || navigator.userAgent;

  return ua.indexOf('Trident/7') !== -1;
};

var isIe = function isIE(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;

  return ua.indexOf('MSIE') !== -1 || isIe11(ua);
};

var isIe9 = function isIe9(ua) {
  ua = ua || navigator.userAgent;
...
function parse(url) {
  ...
  url = url || commonjsGlobal.location.href;
...
function _createScriptTag(url, callbackName) {
  ...
  script.onerror = function () {
    commonjsGlobal[callbackName]({message: 'error', status: 500});
  };
...
function _cleanupGlobal(callbackName) {
  try {
    delete commonjsGlobal[callbackName];
  } catch (_) {
    commonjsGlobal[callbackName] = null;
  }
}
...
function _setupTimeout(timeout, callbackName) {
  timeouts[callbackName] = setTimeout(function () {
    ...
    commonjsGlobal[callbackName]({
      error: 'timeout',
      status: -1
    });

    commonjsGlobal[callbackName] = function () {
...
function _setupGlobalCallback(script, callback, callbackName) {
  commonjsGlobal[callbackName] = function (response) {
...
function request(options, callback) {
  var script;
  var callbackName = 'callback_json_' + uuid_1().replace(/-/g, '');
  var url = options.url;
...
var assignNormalized$1 = typeof Object.assign === 'function' ? Object.assign : assignPolyfill$1;

function assignPolyfill$1(destination) {
  var i, source, key;
...
var assign$1 = {
  assign: assignNormalized$1,
  _assign: assignPolyfill$1
};

var prepBody = function (method, body) {
...
var isXHRAvailable = commonjsGlobal.XMLHttpRequest && 'withCredentials' in new commonjsGlobal.XMLHttpRequest();

function getRequestObject() {
  return isXHRAvailable ? new commonjsGlobal.XMLHttpRequest() : new commonjsGlobal.XDomainRequest();
}
...
var creditCardTokenization_1 = creditCardTokenization;
...
var error = errorResponseAdapter;
...
function creditCardTokenizationResponseAdapter(responseBody) {
  ...
  if (responseBody.data && !responseBody.errors) {
    ...
    adaptedResponse = error(responseBody);
  }
...
var creditCardTokenization$1 = creditCardTokenizationResponseAdapter;
...
function adaptConfigurationResponseBody(body, ctx) {
  ...
  if (configuration.paypal) {
    ...
    response.paypal = assign$3({}, configuration.paypal);
...
var configuration$1 = configurationResponseAdapter;

var BRAINTREE_VERSION = constants$1.BRAINTREE_VERSION;

var assign$4 = assign$1.assign;
...
var generators = {
  'payment_methods/credit_cards': creditCardTokenization_1,
  configuration: configuration_1
};
var adapters = {
  'payment_methods/credit_cards': creditCardTokenization$1,
...
GraphQLRequest.prototype.getBody = function () {
  ...
  var body = assign$4({clientSdkMetadata: this._clientSdkMetadata}, generatedBody);
...
GraphQLRequest.prototype.getHeaders = function () {
  ...
  return assign$4({}, this._headers, headers);
};
...
var assign$5 = assign$1.assign;



var isXHRAvailable$1 = xhr.isAvailable;
...
function _requestWithRetry(options, tcpRetryCount, cb) {
  ...
  options.headers = assign$5({'Content-Type': 'application/json'}, options.headers);

  if (isGraphQLRequest) {
    ajaxRequest = new request$1(options);
  } else {
...
var getUserAgent = function getUserAgent() {
  return commonjsGlobal.navigator.userAgent;
};

var isHttp = function () {
  return commonjsGlobal.location.protocol === 'http:';
};
...
var request$3 = function (options, cb) {
  cb = once_1(cb || Function.prototype);
...
var isVerifiedDomain_1 = isVerifiedDomain;
...
var convertToBraintreeError_1 = convertToBraintreeError;
...
var Promise$1 = commonjsGlobal.Promise || Promise;
...
var promiseOrCallback_1 = promiseOrCallback;
...
function wrapPromise(fn) {
  return function () {
    ...
    if (typeof lastArg === 'function') {
      callback = args.pop();
      callback = once_1$1(deferred_1(callback));
    }

    return promiseOrCallback_1(fn.apply(this, args), callback); // eslint-disable-line no-invalid-this
  };
}
...
var atobNormalized$1 = typeof commonjsGlobal.atob === 'function' ? commonjsGlobal.atob : atob$1;

function atob$1(base64String) {
  var a, b, c, b1, b2, b3, b4, i;
  var base64Matcher = new RegExp('^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{4})([=]{1,2})?$');
  var characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
  var result = '';
...
var polyfill$1 = {
  atob: function (base64String) {
    return atobNormalized$1.call(commonjsGlobal, base64String);
  },
  _atob: atob$1
};

var atob$2 = polyfill$1.atob;
var CLIENT_API_URLS$1 = constants$2.CLIENT_API_URLS;
...
function createAuthorizationData(authorization) {
  ...
  if (_isTokenizationKey(authorization)) {
    ...
    data.configUrl = CLIENT_API_URLS$1[parsedTokenizationKey.environment] + '/merchants/' + parsedTokenizationKey.merchantId + '/client_api/v1/configuration';
  } else {
    parsedClientToken = JSON.parse(atob$2(authorization));
...
var createAuthorizationData_1 = createAuthorizationData;
...
var isDateStringBeforeOrOn_1 = isDateStringBeforeOrOn;

var BRAINTREE_VERSION$1 = constants$1.BRAINTREE_VERSION;

function getConfiguration(options) {
  return new promise(function (resolve, reject) {
    var configuration, authData, attrs, configUrl, reqOptions;
    var sessionId = uuid_1();
    var analyticsMetadata = {
      merchantAppId: commonjsGlobal.location.host,
      platform: constants$2.PLATFORM,
      sdkVersion: constants$2.VERSION,
      source: constants$2.SOURCE,
      integration: constants$2.INTEGRATION,
      integrationType: constants$2.INTEGRATION,
      sessionId: sessionId
    };

    try {
      authData = createAuthorizationData_1(options.authorization);
    } catch (err) {
    ...
    attrs.braintreeLibraryVersion = constants$2.BRAINTREE_LIBRARY_VERSION;
    ...
    if (attrs.authorizationFingerprint && authData.graphQL) {
      if (isDateStringBeforeOrOn_1(authData.graphQL.date, BRAINTREE_VERSION$1)) {
    ...
    request$3(reqOptions, function (err, response, status) {
      var errorTemplate;
...
var getConfiguration_1 = {
  getConfiguration: wrapPromise_1(getConfiguration)
};
...
function addMetadata(configuration, data) {
  ...
  var authAttrs = createAuthorizationData_1(configuration.authorization).attrs;
...
var addMetadata_1 = addMetadata;

var deferred$1 = function (fn) {
  return function () {
    // IE9 doesn't support passing arguments to setTimeout so we have to emulate it.
    var args = arguments;
...
function sendAnalyticsEvent(clientInstanceOrPromise, kind, callback) {
  ...
  return promise.resolve(clientInstanceOrPromise).then(function (client) {
    ...
    var data = {
      analytics: [{
        kind: constants$2.ANALYTICS_PREFIX + kind,
    ...
    request({
      url: url,
      method: 'post',
      data: addMetadata_1(configuration, data),
      timeout: constants$2.ANALYTICS_REQUEST_TIMEOUT_MS
    }, callback);
  });
}
...
var convertMethodsToError = function (instance, methodNames) {
  methodNames.forEach(function (methodName) {
    instance[methodName] = function () {
      throw new braintreeError({
        type: errors$1.METHOD_CALLED_AFTER_TEARDOWN.type,
        code: errors$1.METHOD_CALLED_AFTER_TEARDOWN.code,
...
function loadScript(options) {
  ...
  scriptLoadPromise = new promise$1(function (resolve, reject) {
...
var assets = {
  loadScript: loadScript_1
};

var BRAINTREE_VERSION$2 = constants$1.BRAINTREE_VERSION;
...
var getGatewayConfiguration = getConfiguration_1.getConfiguration;





var assign$6 = assign$1.assign;


var VERSION$1 = constants$2.VERSION;
var GRAPHQL_URLS$1 = constants$2.GRAPHQL_URLS;



var FRAUDNET_FNCLS = constants$2.FRAUDNET_FNCLS;
var FRAUDNET_SOURCE = constants$2.FRAUDNET_SOURCE;
var FRAUDNET_URL = constants$2.FRAUDNET_URL;
...
function Client(configuration) {
  ...
  [
    ...
    if (property in gatewayConfiguration && !isVerifiedDomain_1(gatewayConfiguration[property])) {
      throw new braintreeError({
...
Client.initialize = function (options) {
  var clientInstance;
  var promise$1 = cachedClients[options.authorization];

  if (promise$1) {
    analytics.sendEvent(promise$1, 'custom.client.load.cached');

    return promise$1;
  }

  promise$1 = getGatewayConfiguration(options).then(function (configuration) {
    if (options.debug) {
  ...
  cachedClients[options.authorization] = promise$1;

  analytics.sendEvent(promise$1, 'custom.client.load.initialized');

  return promise$1.then(function (client) {
...
Client.prototype.request = function (options, callback) {
  ...
  var requestPromise = new promise(function (resolve, reject) {
    ...
    if (api === 'clientApi') {
      ...
      requestOptions.data = addMetadata_1(self._configuration, options.data);
    } else if (api === 'graphQLApi') {
      baseUrl = GRAPHQL_URLS$1[self._configuration.gatewayConfiguration.environment];
      options.endpoint = '';
      requestOptions.method = 'post';
      requestOptions.data = assign$6({
        clientSdkMetadata: {
    ...
    self._request(requestOptions, function (err, data, status) {
      ...
      if (api === 'graphQLApi' && data.errors) {
        reject(convertToBraintreeError_1(data.errors, {
      ...
      resolvedData = assign$6({_httpStatus: status}, data);
  ...
  if (typeof callback === 'function') {
    callback = once_1(deferred$1(callback));
...
function formatRequestError(status, err) { // eslint-disable-line consistent-return
  ...
  if (status === -1) {
    ...
    requestError = convertToBraintreeError_1(err, {
 ...
 * @returns {Promise|void} Returns a promise if no callback is provided.
 */
Client.prototype.teardown = wrapPromise_1(function () {
  var self = this; // eslint-disable-line no-invalid-this
...
function create(options) {
  if (!options.authorization) {
    return promise.reject(new braintreeError({
      type: errors$1.INSTANTIATION_OPTION_REQUIRED.type,
      code: errors$1.INSTANTIATION_OPTION_REQUIRED.code,
...
var atob$3 = polyfill.atob;

var braintreeClientVersion = client$1.VERSION;

function _millisToSeconds(millis) {
  return Math.floor(millis / 1000);
}

function sendAnalyticsEvent$1(client, kind, callback) {
  var configuration = client.getConfiguration();
  ...
  if (configuration.authorizationType === 'TOKENIZATION_KEY') {
    ...
    data.authorizationFingerprint = JSON.parse(atob$3(configuration.authorization)).authorizationFingerprint;
  }
...
var analytics$1 = {
  sendEvent: sendAnalyticsEvent$1
};
...
var atob$4 = polyfill.atob;

var isGuestCheckout = function (client) {
  var authorizationFingerprint;
  var configuration = client.getConfiguration();

  if (configuration.authorizationType !== 'TOKENIZATION_KEY') {
    authorizationFingerprint = JSON.parse(atob$4(configuration.authorization)).authorizationFingerprint;
...
var Promise$2 = commonjsGlobal.Promise || Promise;

var promise$2 = Promise$2;

var assign$7 = assign.assign;


var errors$2 = constants.errors;
...
BaseView.prototype.requestPaymentMethod = function () {
  return promise$2.reject(new dropinError(errors$2.NO_PAYMENT_METHOD_ERROR));
};
...
ApplePay.prototype.performValidation = function (options) {
  ...
  if (!options || !options.validationURL) {
    return promise.reject(new braintreeError(errors$3.APPLE_PAY_VALIDATION_URL_REQUIRED));
  }

  applePayWebSession = {
    validationUrl: options.validationURL,
    domainName: options.domainName || commonjsGlobal.location.hostname,
  ...
  return this._client.request({
    ...
    if (err.code === 'CLIENT_REQUEST_ERROR') {
      return promise.reject(new braintreeError({
        type: errors$3.APPLE_PAY_MERCHANT_VALIDATION_FAILED.type,
        code: errors$3.APPLE_PAY_MERCHANT_VALIDATION_FAILED.code,
        message: errors$3.APPLE_PAY_MERCHANT_VALIDATION_FAILED.message,
        details: {
    ...
    return promise.reject(new braintreeError({
      type: errors$3.APPLE_PAY_MERCHANT_VALIDATION_NETWORK.type,
      code: errors$3.APPLE_PAY_MERCHANT_VALIDATION_NETWORK.code,
      message: errors$3.APPLE_PAY_MERCHANT_VALIDATION_NETWORK.message,
      details: {
        originalError: err
      }
    }));
...
ApplePay.prototype.tokenize = function (options) {
  ...
  if (!options.token) {
    return promise.reject(new braintreeError(errors$3.APPLE_PAY_PAYMENT_TOKEN_REQUIRED));
  }
  ...
  return this._client.request({
    ...
    return promise.reject(new braintreeError({
      type: errors$3.APPLE_PAY_TOKENIZATION.type,
      code: errors$3.APPLE_PAY_TOKENIZATION.code,
      message: errors$3.APPLE_PAY_TOKENIZATION.message,
      details: {
        originalError: err
      }
    }));
...
var applePay = wrapPromise_1.wrapPrototype(ApplePay);

var VERSION$3 = "3.52.0";
...
function basicComponentVerification(options) {
  ...
  if (!options) {
    return promise.reject(new braintreeError({
      type: errors$1.INVALID_USE_OF_INTERNAL_FUNCTION.type,
      code: errors$1.INVALID_USE_OF_INTERNAL_FUNCTION.code,
  ...
  if (!authorization && client.getVersion() !== VERSION$3) {
    return promise.reject(new braintreeError({
      type: errors$1.INCOMPATIBLE_VERSIONS.type,
      code: errors$1.INCOMPATIBLE_VERSIONS.code,
      message: 'Client (version ' + client.getVersion() + ') and ' + name + ' (version ' + VERSION$3 + ') components must be from the same SDK version.'
    }));
  }
...
var basicComponentVerification_1 = {
  verify: basicComponentVerification
};

var VERSION$4 = "3.52.0";

function createDeferredClient(options) {
  var promise$1 = promise.resolve();

  if (options.client) {
    return promise.resolve(options.client);
  }

  if (!(commonjsGlobal.braintree && commonjsGlobal.braintree.client)) {
    promise$1 = assets.loadScript({
      src: options.assetsUrl + '/web/' + VERSION$4 + '/js/client.min.js'
    }).catch(function (err) {
      return promise.reject(new braintreeError({
        type: errors$1.CLIENT_SCRIPT_FAILED_TO_LOAD.type,
        code: errors$1.CLIENT_SCRIPT_FAILED_TO_LOAD.code,
        message: errors$1.CLIENT_SCRIPT_FAILED_TO_LOAD.message,
        details: {
          originalError: err
        }
      }));
  ...
  return promise$1.then(function () {
    if (commonjsGlobal.braintree.client.VERSION !== VERSION$4) {
      return promise.reject(new braintreeError({
        type: errors$1.INCOMPATIBLE_VERSIONS.type,
        code: errors$1.INCOMPATIBLE_VERSIONS.code,
        message: 'Client (version ' + commonjsGlobal.braintree.client.VERSION + ') and ' + options.name + ' (version ' + VERSION$4 + ') components must be from the same SDK version.'
      }));
    }

    return commonjsGlobal.braintree.client.create({
      authorization: options.authorization,
      debug: options.debug
    });
  });
...
var createDeferredClient_1 = {
  create: createDeferredClient
};

var ASSETS_URLS$1 = constants$2.ASSETS_URLS;

function createAssetsUrl(authorization) {

  return ASSETS_URLS$1.production;
}
/* eslint-enable */

var createAssetsUrl_1 = {
...
function create$1(options) {
  ...
  return basicComponentVerification_1.verify({
    name: name,
    client: options.client,
    authorization: options.authorization
  }).then(function () {
    return createDeferredClient_1.create({
      authorization: options.authorization,
      client: options.client,
      debug: options.debug,
      assetsUrl: createAssetsUrl_1.create(options.authorization),
      name: name
    });
    ...
    if (!options.client.getConfiguration().gatewayConfiguration.applePayWeb) {
      return promise.reject(new braintreeError(errors$3.APPLE_PAY_NOT_ENABLED));
    }
...
function isHTTPS() {
  return commonjsGlobal.location.protocol === 'https:';
}
...
ApplePayView.prototype.initialize = function () {
  ...
  self.applePayConfiguration = assign$8({}, self.model.merchantConfiguration.applePay);
  ...
  return applePay$1.create({client: this.client}).then(function (applePayInstance) {
    ...
    self.model.on('changeActivePaymentView', function (paymentViewID) {
      ...
      commonjsGlobal.ApplePaySession.canMakePaymentsWithActiveCard(self.applePayInstance.merchantIdentifier).then(function (canMakePayments) {
        if (!canMakePayments) {
...
ApplePayView.prototype._showPaymentSheet = function () {
  ...
  var session = new commonjsGlobal.ApplePaySession(self.applePaySessionVersion, request);
  ...
  session.onpaymentauthorized = function (event) {
    self.applePayInstance.tokenize({
      ...
      session.completePayment(commonjsGlobal.ApplePaySession.STATUS_SUCCESS);
      payload.rawPaymentData = event.payment;
      self.model.addPaymentMethod(payload);
    }).catch(function (tokenizeErr) {
      self.model.reportError(tokenizeErr);
      session.completePayment(commonjsGlobal.ApplePaySession.STATUS_FAILURE);
    });
  };
...
ApplePayView.isEnabled = function (options) {
  ...
  if (!applePayEnabled) {
    return promise$2.resolve(false);
  }

  applePayBrowserSupported = commonjsGlobal.ApplePaySession && isHttps.isHTTPS();

  if (!applePayBrowserSupported) {
    return promise$2.resolve(false);
  }

  if (!commonjsGlobal.ApplePaySession.supportsVersion(applePaySessionVersion)) {
    return promise$2.resolve(false);
  }

  return promise$2.resolve(Boolean(commonjsGlobal.ApplePaySession.canMakePayments()));
};
...
var batchExecuteFunctions = function (functions, cb) {
  var i;
  var length = functions.length;
  var remaining = length;
  var callback = once_1(cb);
...
var assign$9 = function assign(target) {
...
var iframer = function createFrame(options) {
  var iframe = document.createElement('iframe');
  var config = assign$9({}, defaultAttributes, options);

  if (config.style && typeof config.style !== 'string') {
    assign$9(iframe.style, config.style);
    delete config.style;
  }
...
var framebus_1 = framebus;

var events = enumerate_1([
...
function checkOrigin(postMessageOrigin, merchantUrl) {
  ...
  return isVerifiedDomain_1(postMessageOrigin);
}
...
var checkOrigin$1 = checkOrigin_1.checkOrigin;
...
BraintreeBus.prototype.on = function (eventName, originalHandler) {
  ...
  if (this.merchantUrl) {
    handler = function () {
      ...
      if (checkOrigin$1(this.origin, self.merchantUrl)) {
  ...
  this._log('on', args);
  framebus_1.on.apply(framebus_1, args);
...
BraintreeBus.prototype.emit = function (eventName) {
  ...
  this._log('emit', args);
  framebus_1.emit.apply(framebus_1, args);
};
...
BraintreeBus.prototype._offDirect = function (eventName) {
  ...
  this._log('off', args);
  framebus_1.off.apply(framebus_1, args);
};
...
var constants$3 = {
  ...
  tokenizationErrorCodes: {
    81724: errors$4.HOSTED_FIELDS_TOKENIZATION_FAIL_ON_DUPLICATE,
    ...
    // failures
    81736: errors$4.HOSTED_FIELDS_TOKENIZATION_CVV_VERIFICATION_FAILED
  },
  allowedStyles: [
    '-moz-appearance',
...
constants$3.events = enumerate_1([
  'ADD_CLASS',
...
var composeUrl = function composeUrl(assetsUrl, componentId, isDebug) {
  return assetsUrl +
    '/web/' +
    constants_1.VERSION +
    '/html/hosted-fields-frame' + useMin_1(isDebug) + '.html#' +
    componentId;
};

var allowedStyles = constants_1.allowedStyles;

var getStylesFromClass = function getStylesFromClass(cssClass) {
  ...
  commonjsGlobal.document.body.appendChild(element);

  computedStyles = commonjsGlobal.getComputedStyle(element);
  ...
  commonjsGlobal.document.body.removeChild(element);
...
var findParentTags_1 = findParentTags;

var isEdge = function isEdge(ua) {
  ua = ua || navigator.userAgent;

  return ua.indexOf('Edge/') !== -1;
};

var isIos = function isIos(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;
...
var isIosWebview = function isIosWebview(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;
  if (isIos(ua)) {
...
var injectFrame = function injectFrame(frame, container) {
...
var findBestMatch_1 = findBestMatch;

function isValidInputType(cardNumber) {
  return typeof cardNumber === 'string' || cardNumber instanceof String;
}

var isValidInputType_1 = isValidInputType;
...
function addMatchingCardsToResults(cardNumber, cardConfiguration, results) {
  ...
  for (i = 0; i < cardConfiguration.patterns.length; i++) {
    ...
    if (!matches_1(cardNumber, pattern)) {
      continue;
    }

    clonedCardConfiguration = clone_1(cardConfiguration);
...
var addMatchingCardsToResults_1 = addMatchingCardsToResults;
...
testOrder = clone_1(ORIGINAL_TEST_ORDER);

function findType(type) {
  return customCards[type] || cardTypes_1[type];
}

function getAllCardTypes() {
  return testOrder.map(function (type) {
    return clone_1(findType(type));
  });
}
...
function creditCardType(cardNumber) {
  ...
  if (!isValidInputType_1(cardNumber)) {
    return [];
  }
  ...
  testOrder.forEach(function (type) {
    ...
    addMatchingCardsToResults_1(cardNumber, cardConfiguration, results);
  });

  bestMatch = findBestMatch_1(results);
...
creditCardType.updateCard = function (cardType, updates) {
  ...
  clonedCard = clone_1(originalObject);
...
var getCardTypes = function (number) {
  var results = creditCardType_1(number);
...
var allowedAttributes = constants_1.allowedAttributes;
...
function attributeValidationError(attribute, value) {
  ...
  if (!allowedAttributes.hasOwnProperty(attribute)) {
    err = new braintreeError({
      type: errors$4.HOSTED_FIELDS_ATTRIBUTE_NOT_SUPPORTED.type,
      code: errors$4.HOSTED_FIELDS_ATTRIBUTE_NOT_SUPPORTED.code,
      message: 'The "' + attribute + '" attribute is not supported in Hosted Fields.'
    });
  } else if (value != null && !_isValid(attribute, value)) {
    err = new braintreeError({
      type: errors$4.HOSTED_FIELDS_ATTRIBUTE_VALUE_NOT_ALLOWED.type,
      code: errors$4.HOSTED_FIELDS_ATTRIBUTE_VALUE_NOT_ALLOWED.code,
...
var attributeValidationError_1 = attributeValidationError;

var assign$a = assign$1.assign;
...
var INTEGRATION_TIMEOUT_MS = constants$2.INTEGRATION_TIMEOUT_MS;



var events$1 = constants_1.events;



var allowedFields = constants_1.allowedFields;
...
function createInputEventHandler(fields) {
  return function (eventData) {
    ...
    classList.toggle(container, constants_1.externalClasses.FOCUSED, field.isFocused);
    classList.toggle(container, constants_1.externalClasses.VALID, field.isValid);
    classList.toggle(container, constants_1.externalClasses.INVALID, !field.isPotentiallyValid);
...
function isVisibleEnough(node) {
  ...
  return (
    boundingBox.top < (commonjsGlobal.innerHeight - verticalMidpoint || document.documentElement.clientHeight - verticalMidpoint) &&
    boundingBox.right > horizontalMidpoint &&
    boundingBox.bottom > verticalMidpoint &&
    boundingBox.left < (commonjsGlobal.innerWidth - horizontalMidpoint || document.documentElement.clientWidth - horizontalMidpoint)
  );
}
...
function HostedFields(options) {
  ...
  var componentId = uuid_1();

  this._merchantConfigurationOptions = assign$a({}, options);
  ...
  this._clientPromise = createDeferredClient_1.create({
    client: options.client,
    authorization: options.authorization,
    debug: isDebug,
    assetsUrl: assetsUrl,
  ...
  Object.keys(options.fields).forEach(function (key) {
    ...
    if (!constants_1.allowedFields.hasOwnProperty(key)) {
      throw new braintreeError({
        type: errors$4.HOSTED_FIELDS_INVALID_FIELD_KEY.type,
        code: errors$4.HOSTED_FIELDS_INVALID_FIELD_KEY.code,
    ...
    if (!container || container.nodeType !== 1) {
      throw new braintreeError({
        type: errors$4.HOSTED_FIELDS_INVALID_FIELD_SELECTOR.type,
        code: errors$4.HOSTED_FIELDS_INVALID_FIELD_SELECTOR.code,
        message: errors$4.HOSTED_FIELDS_INVALID_FIELD_SELECTOR.message,
        details: {
      ...
      throw new braintreeError({
        type: errors$4.HOSTED_FIELDS_FIELD_DUPLICATE_IFRAME.type,
        code: errors$4.HOSTED_FIELDS_FIELD_DUPLICATE_IFRAME.code,
        message: errors$4.HOSTED_FIELDS_FIELD_DUPLICATE_IFRAME.message,
        details: {
          fieldSelector: field.selector,
          fieldContainer: field.container,
          fieldKey: key
    ...
    if (field.maxlength && typeof field.maxlength !== 'number') {
      throw new braintreeError({
        type: errors$4.HOSTED_FIELDS_FIELD_PROPERTY_INVALID.type,
        code: errors$4.HOSTED_FIELDS_FIELD_PROPERTY_INVALID.code,
    ...
    frame = iframer({
      ...
      style: constants_1.defaultIFrameStyle,
      title: 'Secure Credit Card Frame - ' + constants_1.allowedFields[key].label
    });
    ...
    setTimeout(function () {
      ...
      // setTimeout to work.
      if (browserDetection$1.isIE() || browserDetection$1.isEdge()) {
  ...
  this._bus.on(events$1.READY_FOR_CLIENT, function (reply) {
    self._clientPromise.then(function (client) {
      reply(client);
    });
  });

  this._bus.on(events$1.CARD_FORM_ENTRY_HAS_BEGUN, function () {
    analytics.sendEvent(self._clientPromise, 'hosted-fields.input.started');
  });

  this._bus.on(events$1.BIN_AVAILABLE, function (bin) {
  ...
  this._bus.on(events$1.FRAME_READY, function (data, reply) {
    frameReadyPromiseResolveFunctions[data.field](reply);
  });

  this._bus.on(
    events$1.INPUT_EVENT,
    createInputEventHandler(fields).bind(this)
  );

  this._bus.on(events$1.TRIGGER_INPUT_FOCUS, function (fieldName) {
  ...
  this._destructor.registerFunctionForTeardown(function () {
    ...
    for (j = 0; j < self._injectedNodes.length; j++) {
      ...
      classList.remove(
        parent,
        constants_1.externalClasses.FOCUSED,
        constants_1.externalClasses.INVALID,
        constants_1.externalClasses.VALID
      );
    }
  });
...
HostedFields.prototype._setupLabelFocus = function (type, container) {
  var labels, i;
  var shouldSkipLabelFocus = browserDetection$1.isIos();
  var bus = this._bus;
  ...
  function triggerFocus() {
    bus.emit(events$1.TRIGGER_INPUT_FOCUS, type);
  }

  labels = Array.prototype.slice.call(document.querySelectorAll('label[for="' + container.id + '"]'));
  labels = labels.concat(findParentTags_1(container, 'label'));
...
HostedFields.prototype.tokenize = function (options) {
  ...
  return new promise(function (resolve, reject) {
    self._bus.emit(events$1.TOKENIZATION_REQUEST, options, function (response) {
      var err = response[0];
...
HostedFields.prototype.addClass = function (field, classname) {
  ...
  if (!allowedFields.hasOwnProperty(field)) {
    err = new braintreeError({
      type: errors$4.HOSTED_FIELDS_FIELD_INVALID.type,
      code: errors$4.HOSTED_FIELDS_FIELD_INVALID.code,
      message: '"' + field + '" is not a valid field. You must use a valid field option when adding a class.'
    });
  } else if (!this._fields.hasOwnProperty(field)) {
    err = new braintreeError({
      type: errors$4.HOSTED_FIELDS_FIELD_NOT_PRESENT.type,
      code: errors$4.HOSTED_FIELDS_FIELD_NOT_PRESENT.code,
      message: 'Cannot add class to "' + field + '" field because it is not part of the current Hosted Fields options.'
    });
  } else {
    this._bus.emit(events$1.ADD_CLASS, field, classname);
  }
...
HostedFields.prototype.removeClass = function (field, classname) {
  ...
  if (!allowedFields.hasOwnProperty(field)) {
    ...
    this._bus.emit(events$1.REMOVE_CLASS, field, classname);
  }
...
HostedFields.prototype.setAttribute = function (options) {
  ...
  if (!allowedFields.hasOwnProperty(options.field)) {
    ...
    attributeErr = attributeValidationError_1(options.attribute, options.value);

    if (attributeErr) {
      err = attributeErr;
    } else {
      this._bus.emit(events$1.SET_ATTRIBUTE, options.field, options.attribute, options.value);
    }
  }
...
HostedFields.prototype.setMonthOptions = function (options) {
  ...
  return new promise(function (resolve) {
    self._bus.emit(events$1.SET_MONTH_OPTIONS, options, resolve);
  });
};
...
HostedFields.prototype.setMessage = function (options) {
  this._bus.emit(events$1.SET_MESSAGE, options.field, options.message);
};
...
HostedFields.prototype.removeAttribute = function (options) {
  ...
  if (!allowedFields.hasOwnProperty(options.field)) {
    ...
    attributeErr = attributeValidationError_1(options.attribute);

    if (attributeErr) {
      err = attributeErr;
    } else {
      this._bus.emit(events$1.REMOVE_ATTRIBUTE, options.field, options.attribute);
    }
  }
...
HostedFields.prototype.clear = function (field) {
  ...
  if (!allowedFields.hasOwnProperty(field)) {
    ...
    this._bus.emit(events$1.CLEAR_FIELD, field);
  }
...
HostedFields.prototype.focus = function (field) {
  ...
  if (!allowedFields.hasOwnProperty(field)) {
    ...
    this._bus.emit(events$1.TRIGGER_INPUT_FOCUS, field);
  }
...
var hostedFields = wrapPromise_1.wrapPrototype(HostedFields);

var isAndroid = function isAndroid(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;

  return /Android/.test(ua);
};

var isChromeOs = function isChromeOS(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;

  return /CrOS/i.test(ua);
};

var isSamsung = function isSamsungBrowser(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;

  return /SamsungBrowser/i.test(ua);
};

var isChrome = function isChrome(ua) {
  ua = ua || navigator.userAgent;

  return (ua.indexOf('Chrome') !== -1 || ua.indexOf('CriOS') !== -1) && !isEdge(ua) && !isSamsung(ua);
};

var UA = commonjsGlobal.navigator && commonjsGlobal.navigator.userAgent;
...
var supportsInputFormatting = function () {
  ...
  return basicComponentVerification_1.verify({
    ...
    return new promise(function (resolve, reject) {
      ...
      integration.on('timeout', function () {
        reject(new braintreeError(errors$4.HOSTED_FIELDS_TIMEOUT));
      });
    });
  });
}
...
var isUtf8 = function (win) {
  win = win || commonjsGlobal;

  return Boolean(win.document.characterSet && win.document.characterSet.toLowerCase() === 'utf-8');
};

var isIe10 = function isIe10(ua) {
  ua = ua || navigator.userAgent;

  return ua.indexOf('MSIE 10') !== -1;
};

var browserDetection$2 = {
  isIe9: isIe9,
  isIe10: isIe10
};
...
function onTransitionEnd(element, propertyName, callback) {
  if (browserDetection$2.isIe9() || isHidden(element)) {
    callback();
...
CardView.prototype.initialize = function () {
  ...
  return hostedFields$1.create(hfOptions).then(function (hostedFieldsInstance) {
...
CardView.prototype._generateHostedFieldsOptions = function () {
  ...
  if (overrides.fields) {
    ...
    Object.keys(overrides.fields).forEach(function (field) {
      ...
      assign$b(options.fields[field], overrides.fields[field], {
  ...
  if (overrides.styles) {
    Object.keys(overrides.styles).forEach(function (style) {
      ...
      assign$b(options.styles[style], overrides.styles[style]);
    });
  }
...
CardView.prototype.tokenize = function () {
  ...
  if (!this._validateForm(true)) {
    ...
    return promise$2.reject(new dropinError(constants.errors.NO_PAYMENT_METHOD_ERROR));
  }
  ...
  return self.hostedFieldsInstance.tokenize(tokenizeOptions).then(function (payload) {
    ...
    return promise$2.reject(new dropinError({
...
CardView.isEnabled = function (options) {
  ...
  return promise$2.resolve(!disabledByMerchant && gatewayConfiguration.creditCards.supportedCardTypes.length > 0);
};
...
var VERSION$8 = "3.52.0";
var assign$c = assign$1.assign;
...
function generateTokenizationParameters(configuration, overrides) {
  ...
  var basicTokenizationParameters = {
    ...
    'braintree:sdkVersion': VERSION$8,
  ...
  return assign$c({}, basicTokenizationParameters, overrides);
}

var generateGooglePayConfiguration = function (configuration, googlePayVersion, googleMerchantId) {
...
GooglePayment.prototype._initialize = function () {
  if (this._isUnsupportedGooglePayAPIVersion()) {
    return promise.reject(new braintreeError({
      code: errors$5.GOOGLE_PAYMENT_UNSUPPORTED_VERSION.code,
      ...
      type: errors$5.GOOGLE_PAYMENT_UNSUPPORTED_VERSION.type
    }));
  }
...
GooglePayment.prototype._createV1PaymentDataRequest = function (paymentDataRequest) {
  ...
  paymentDataRequest = assign$d({}, defaultConfig, paymentDataRequest);
...
GooglePayment.prototype.createPaymentDataRequest = function (overrides) {
  var paymentDataRequest = assign$d({}, overrides);
...
GooglePayment.prototype.parseResponse = function (response) {
  ...
  return promise.resolve().then(function () {
    ...
    return promise.reject(new braintreeError({
      code: errors$5.GOOGLE_PAYMENT_GATEWAY_ERROR.code,
      message: errors$5.GOOGLE_PAYMENT_GATEWAY_ERROR.message,
      type: errors$5.GOOGLE_PAYMENT_GATEWAY_ERROR.type,
      details: {
        originalError: error
      }
    }));
...
function applyDefaultsToPaymentMethodConfiguration(merchantSubmittedPaymentMethod, defaultPaymentMethod) {
  Object.keys(defaultPaymentMethod).forEach(function (parameter) {
    if (typeof defaultPaymentMethod[parameter] === 'object') {
      merchantSubmittedPaymentMethod[parameter] = assign$d(
        {},
...
var googlePayment = wrapPromise_1.wrapPrototype(GooglePayment);
...
function create$3(options) {
  ...
  return basicComponentVerification_1.verify({
    ...
    if (!options.client.getConfiguration().gatewayConfiguration.androidPay) {
      return promise.reject(new braintreeError(errors$5.GOOGLE_PAYMENT_NOT_ENABLED));
    }
...
var loadStylesheet = function loadStylesheet(options) {
  var container;
  var stylesheet = document.querySelector('link[href="' + options.href + '"]');

  if (stylesheet) {
    return promise$1.resolve(stylesheet);
  }
...
GooglePayView.prototype.initialize = function () {
  ...
  self.googlePayConfiguration = assign$e({}, self.model.merchantConfiguration.googlePay);
...
GooglePayView.prototype.tokenize = function () {
  ...
  return self.paymentsClient.loadPaymentData(paymentDataRequest).then(function (paymentData) {
    ...
    if (err.statusCode === 'DEVELOPER_ERROR') {
      ...
      analytics$1.sendEvent(self.client, 'googlepay.loadPaymentData.canceled');

      return;
    } else if (err.statusCode) {
      analytics$1.sendEvent(self.client, 'googlepay.loadPaymentData.failed');
    }
...
GooglePayView.isEnabled = function (options) {
  ...
  return promise$2.resolve().then(function () {
    if (!(commonjsGlobal.google && commonjsGlobal.google.payments && commonjsGlobal.google.payments.api && commonjsGlobal.google.payments.api.PaymentsClient)) {
      return assetLoader.loadScript({
  ...
  this._clientPromise = createDeferredClient_1.create({
    ...
    if (!this._merchantAccountId) {
      if (!this._configuration.gatewayConfiguration.paypalEnabled) {
        this._setupError = new braintreeError(errors$6.PAYPAL_NOT_ENABLED);
      } else if (this._configuration.gatewayConfiguration.paypal.environmentNoNetwork === true) {
        this._setupError = new braintreeError(errors$6.PAYPAL_SANDBOX_ACCOUNT_NOT_LINKED);
      }
    }
...
PayPalCheckout.prototype.createPayment = function (options) {
  ...
  if (!options || !constants$4.FLOW_ENDPOINTS.hasOwnProperty(options.flow)) {
    return promise.reject(new braintreeError(errors$6.PAYPAL_FLOW_OPTION_REQUIRED));
  }

  endpoint = 'paypal_hermes/' + constants$4.FLOW_ENDPOINTS[options.flow];
  ...
  return this._clientPromise.then(function (client) {
    ...
    if (status === 422) {
      return promise.reject(new braintreeError({
        type: errors$6.PAYPAL_INVALID_PAYMENT_OPTION.type,
        code: errors$6.PAYPAL_INVALID_PAYMENT_OPTION.code,
        message: errors$6.PAYPAL_INVALID_PAYMENT_OPTION.message,
        details: {
          originalError: err
        }
      }));
    ...
    return promise.reject(convertToBraintreeError_1(err, {
      type: errors$6.PAYPAL_FLOW_FAILED.type,
      code: errors$6.PAYPAL_FLOW_FAILED.code,
      message: errors$6.PAYPAL_FLOW_FAILED.message
    }));
  });
};
...
PayPalCheckout.prototype.tokenizePayment = function (tokenizeOptions) {
  ...
  return this._clientPromise.then(function (client) {
    ...
    return promise.reject(convertToBraintreeError_1(err, {
      type: errors$6.PAYPAL_ACCOUNT_TOKENIZATION_FAILED.type,
      code: errors$6.PAYPAL_ACCOUNT_TOKENIZATION_FAILED.code,
      message: errors$6.PAYPAL_ACCOUNT_TOKENIZATION_FAILED.message
    }));
  });
};
...
var paypalCheckout = wrapPromise_1.wrapPrototype(PayPalCheckout);
...
var paypalCheckout$1 = {
  create: wrapPromise_1(create$4),
...
var translations = {
  ...
  translations: assign$f({}, twoCharacterLocaleAliases, fiveCharacterLocales)
};

var assign$g = assign.assign;
...
var translations$1 = translations.fiveCharacterLocales;
...
BasePayPalView.prototype.initialize = function () {
  ...
  this.paypalConfiguration = assign$g({}, paypalConfiguration);
  ...
  return paypalCheckout$1.create({client: this.client}).then(function (paypalInstance) {
    ...
    if (locale && locale in translations$1) {
    ...
    if (isCredit) {
      ...
      checkoutJSConfiguration.funding = {
        disallowed: [commonjsGlobal.paypal.FUNDING.CREDIT]
      };
    }

    return commonjsGlobal.paypal.Button.render(checkoutJSConfiguration, buttonSelector).then(function () {
      self.model.asyncDependencyReady();
      setupComplete = true;
...
BasePayPalView.isEnabled = function (options) {
  ...
  if (browserDetection$2.isIe9() || browserDetection$2.isIe10()) {
    analytics$1.sendEvent(options.client, options.viewID + '.checkout.js-browser-not-supported');

    return promise$2.resolve(false);
  }

  if (commonjsGlobal.paypal && commonjsGlobal.paypal.Button) {
    return promise$2.resolve(true);
  }
  ...
  paypalScriptLoadInProgressPromise = assetLoader.loadScript({
...
var basePaypalView = BasePayPalView;

var assign$h = assign.assign;

var paymentOptionIDs$1 = constants.paymentOptionIDs;
...
PayPalView.ID = PayPalView.prototype.ID = paymentOptionIDs$1.paypal;
...
PayPalView.isEnabled = function (options) {
  ...
  return basePaypalView.isEnabled(assign$h({
    viewID: PayPalView.ID
  }, options));
};

var paypalView = PayPalView;

var assign$i = assign.assign;

var paymentOptionIDs$2 = constants.paymentOptionIDs;
...
PayPalCreditView.ID = PayPalCreditView.prototype.ID = paymentOptionIDs$2.paypalCredit;
...
PayPalCreditView.isEnabled = function (options) {
  ...
  return basePaypalView.isEnabled(assign$i({
    viewID: PayPalCreditView.ID
  }, options));
};
var paypalCreditView = PayPalCreditView;
...
var isIosSafari = function isIosSafari(ua) {
  ua = ua || navigator.userAgent;

  return isIos(ua) && isWebkit(ua) && ua.indexOf('CriOS') === -1;
};

var isIosFirefox = function isIosFirefox(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;

  return /FxiOS/i.test(ua);
};

var isMobileFirefox = function isMobileFirefox(ua) {
  ua = ua || commonjsGlobal.navigator.userAgent;

  return isIosFirefox(ua) || (/iPhone|iPod|iPad|Mobile|Tablet/i.test(ua) && /Firefox/i.test(ua));
};

var browserDetection$3 = {
  isAndroid: isAndroid,
  isChrome: isChrome,
  isIos: isIos,
  isIosSafari: isIosSafari,
  isSamsungBrowser: isSamsung,
  isMobileFirefox: isMobileFirefox
};

function isBrowserSupported(options) {
  var isAndroidChrome = browserDetection$3.isAndroid() && browserDetection$3.isChrome();
  var isIosChrome = browserDetection$3.isIos() && browserDetection$3.isChrome();
  var supportsReturnToSameTab = browserDetection$3.isIosSafari() || isAndroidChrome;
  var supportsReturnToNewTab = isIosChrome || browserDetection$3.isSamsungBrowser() || browserDetection$3.isMobileFirefox();
...
function Venmo(options) {
  ...
  this._assetsUrl = configuration.gatewayConfiguration.assetsUrl + '/web/' + VERSION$b;
...
Venmo.prototype._initialize = function () {
  var params = {};
  var currentUrl = this._deepLinkReturnUrl || commonjsGlobal.location.href.replace(commonjsGlobal.location.hash, '');
  ...
  params.ua = commonjsGlobal.navigator.userAgent;
  /* eslint-disable camelcase */
  ...
  this._url = constants$5.VENMO_OPEN_URL + '?' + querystring.stringify(params);
...
Venmo.prototype.isBrowserSupported = function () {
  return supportsVenmo.isBrowserSupported({
...
Venmo.prototype.tokenize = function () {
  ...
  if (this._tokenizationInProgress === true) {
    return promise.reject(new braintreeError(errors$7.VENMO_TOKENIZATION_REQUEST_ACTIVE));
  }
  ...
  return new promise(function (resolve, reject) {
    ...
    self._previousHash = commonjsGlobal.location.hash;

    // Deep link URLs do not launch iOS apps from a webview when using window.open or PopupBridge.open.
    if (self._deepLinkReturnUrl) {
      commonjsGlobal.location = self._url;
    } else {
      commonjsGlobal.open(self._url);
    }

    // Subscribe to document visibility change events to detect when app switch
    // has returned.
    self._visibilityChangeListener = function () {
      if (!commonjsGlobal.document.hidden) {
        self._tokenizationInProgress = false;

        setTimeout(function () {
          self._processResults().then(resolve).catch(reject).then(function () {
            commonjsGlobal.location.hash = self._previousHash;
            self._removeVisibilityEventListener();
            delete self._visibilityChangeListener;
          });
        }, constants$5.PROCESS_RESULTS_DELAY);
      }
    };

    // Add a brief delay to ignore visibility change events that occur right before app switch
    setTimeout(function () {
      commonjsGlobal.document.addEventListener(documentVisibilityChangeEventName(), self._visibilityChangeListener);
    }, constants$5.DOCUMENT_VISIBILITY_CHANGE_EVENT_DELAY);
  });
};
...
Venmo.prototype._removeVisibilityEventListener = function () {
  commonjsGlobal.document.removeEventListener(documentVisibilityChangeEventName(), this._visibilityChangeListener);
};
...
Venmo.prototype._processResults = function () {
  ...
  return new promise(function (resolve, reject) {
    if (params.venmoSuccess) {
      ...
      reject(new braintreeError({
        type: errors$7.VENMO_APP_FAILED.type,
        code: errors$7.VENMO_APP_FAILED.code,
        message: errors$7.VENMO_APP_FAILED.message,
        details: {
          originalError: {
      ...
      reject(new braintreeError(errors$7.VENMO_APP_CANCELED));
    } else {
      ...
      reject(new braintreeError(errors$7.VENMO_CANCELED));
    }
...
function getFragmentParameters() {
  var keyValuesArray = commonjsGlobal.location.hash.substring(1).split('&');
...
function clearFragmentParameters() {
  if (typeof commonjsGlobal.history.replaceState === 'function' && commonjsGlobal.location.hash) {
    history.pushState({}, '', commonjsGlobal.location.href.slice(0, commonjsGlobal.location.href.indexOf('#')));
  }
}
...
function documentVisibilityChangeEventName() {
  ...
  if (typeof commonjsGlobal.document.hidden !== 'undefined') { // Opera 12.10 and Firefox 18 and later support
    visibilityChange = 'visibilitychange';
  } else if (typeof commonjsGlobal.document.msHidden !== 'undefined') {
    visibilityChange = 'msvisibilitychange';
  } else if (typeof commonjsGlobal.document.webkitHidden !== 'undefined') {
...
var venmo = wrapPromise_1.wrapPrototype(Venmo);
...
function create$5(options) {
  ...
  return basicComponentVerification_1.verify({
    ...
    if (!configuration.gatewayConfiguration.payWithVenmo) {
      return promise.reject(new braintreeError(errors$7.VENMO_NOT_ENABLED));
    }

    if (options.profileId && typeof options.profileId !== 'string') {
      return promise.reject(new braintreeError(errors$7.VENMO_INVALID_PROFILE_ID));
    }

    if (options.deepLinkReturnUrl && typeof options.deepLinkReturnUrl !== 'string') {
      return promise.reject(new braintreeError(errors$7.VENMO_INVALID_DEEP_LINK_RETURN_URL));
    }
 ...
 */
function isBrowserSupported$1(options) {
  return supportsVenmo.isBrowserSupported(options);
}

var venmo$1 = {
  create: wrapPromise_1(create$5),
  isBrowserSupported: isBrowserSupported$1,
  /**
   * @description The current version of the SDK, i.e. `{@pkg version}`.
   * @type {string}
   */
...
var assign$j = assign.assign;




var paymentOptionIDs$3 = constants.paymentOptionIDs;
...
VenmoView.ID = VenmoView.prototype.ID = paymentOptionIDs$3.venmo;

VenmoView.prototype.initialize = function () {
  var self = this;
  var venmoConfiguration = assign$j({}, self.model.merchantConfiguration.venmo, {client: this.client});

  self.model.asyncDependencyStarting();

  return venmo$1.create(venmoConfiguration).then(function (venmoInstance) {
    ...
    return self.venmoInstance.tokenize().then(function (payload) {
      ...
      self.model.reportAppSwitchError(paymentOptionIDs$3.venmo, err);
    });
  }).then(function () {
...
VenmoView.isEnabled = function (options) {
  ...
  return promise$2.resolve(venmo$1.isBrowserSupported(options.merchantConfiguration.venmo));
};

var venmoView = VenmoView;

var paymentOptionIDs$4 = constants.paymentOptionIDs;

var result = {};

result[paymentOptionIDs$4.applePay] = applePayView;
result[paymentOptionIDs$4.card] = cardView;
result[paymentOptionIDs$4.googlePay] = googlePayView;
result[paymentOptionIDs$4.paypal] = paypalView;
result[paymentOptionIDs$4.paypalCredit] = paypalCreditView;
result[paymentOptionIDs$4.venmo] = venmoView;

var paymentSheetViews = result;
...
VaultManager.prototype.deletePaymentMethod = function (paymentMethodNonce) {
  ...
  if (!usesClientToken) {
    return promise.reject(new braintreeError(errors$8.VAULT_MANAGER_DELETE_PAYMENT_METHOD_NONCE_REQUIRES_CLIENT_TOKEN));
  }
  ...
  return this._client.request({
    ...
    if (originalError[0] && originalError[0].extensions.errorClass === 'NOT_FOUND') {
      formattedError = new braintreeError({
        type: errors$8.VAULT_MANAGER_PAYMENT_METHOD_NONCE_NOT_FOUND.type,
        code: errors$8.VAULT_MANAGER_PAYMENT_METHOD_NONCE_NOT_FOUND.code,
    ...
    if (!formattedError) {
      formattedError = new braintreeError({
        type: errors$8.VAULT_MANAGER_DELETE_PAYMENT_METHOD_UNKNOWN_ERROR.type,
        code: errors$8.VAULT_MANAGER_DELETE_PAYMENT_METHOD_UNKNOWN_ERROR.code,
...
var vaultManager = wrapPromise_1.wrapPrototype(VaultManager);
...
var paymentOptionIDs$5 = constants.paymentOptionIDs;
...
var DEFAULT_PAYMENT_OPTION_PRIORITY = [
  paymentOptionIDs$5.card,
  paymentOptionIDs$5.paypal,
  paymentOptionIDs$5.paypalCredit,
  paymentOptionIDs$5.venmo,
  paymentOptionIDs$5.applePay,
  paymentOptionIDs$5.googlePay
];
...
DropinModel.prototype.enableEditMode = function () {
  analytics$1.sendEvent(this._options.client, 'manager.appeared');
...
function getSupportedPaymentOptions(options) {
  ...
  return promise$2.all(promises).then(function (result) {
    result = result.filter(function (item) {
      return item.success;
    });

    if (result.length === 0) {
      return promise$2.reject(new dropinError('No valid payment options available.'));
    }
...
function getPaymentOption(paymentOption, options) {
  return isPaymentOptionEnabled(paymentOption, options).then(function (success) {
    return {
      success: success,
      id: paymentOptionIDs$5[paymentOption]
    };
  });
}

function isPaymentOptionEnabled(paymentOption, options) {
  var SheetView = paymentSheetViews[paymentOptionIDs$5[paymentOption]];

  if (!SheetView) {
    return promise$2.reject(new dropinError('paymentOptionPriority: Invalid payment option specified.'));
  }
...
var addSelectionEventHandler_1 = addSelectionEventHandler;
...
PaymentMethodView.prototype._initialize = function () {
  ...
  addSelectionEventHandler_1(this.element, this._choosePaymentMethod.bind(this));
  ...
  addSelectionEventHandler_1(this.element.querySelector('.braintree-method__delete-container'), this._selectDelete.bind(this));
};
...
PaymentMethodView.prototype._choosePaymentMethod = function () {
  ...
  if (this.paymentMethod.vaulted) {
    analytics$1.sendEvent(this.client, 'vaulted-' + constants.analyticsKinds[this.paymentMethod.type] + '.select');
  }
...
PaymentMethodsView.prototype._initialize = function () {
  ...
  if (this.model.merchantConfiguration.vaultManager) {
    ...
    addSelectionEventHandler_1(this._editButton, function () {
      if (this.model.isInEditMode()) {
...
PaymentMethodsView.prototype._addPaymentMethod = function (paymentMethod) {
  var paymentMethodView$1 = new paymentMethodView({
    model: this.model,
  ...
  if (this.container.firstChild) {
    this.container.insertBefore(paymentMethodView$1.element, this.container.firstChild);
  } else {
    this.container.appendChild(paymentMethodView$1.element);
  }

  this.views.push(paymentMethodView$1);
};
...
PaymentMethodsView.prototype.requestPaymentMethod = function () {
  if (!this.activeMethodView || this.model.isInEditMode()) {
    return promise$2.reject(new dropinError(errors$9.NO_PAYMENT_METHOD_ERROR));
  }

  return promise$2.resolve(this.activeMethodView.paymentMethod);
};
...
var paymentOptionIDs$6 = constants.paymentOptionIDs;
...
PaymentOptionsView.prototype._addPaymentOption = function (paymentOptionID) {
  ...
  var clickHandler = function clickHandler() {
    ...
    analytics$1.sendEvent(this.client, 'selected.' + paymentOptionIDs$6[paymentOptionID]);
  }.bind(this);
  ...
  switch (paymentOptionID) {
    case paymentOptionIDs$6.applePay:
      paymentSource = this.strings['Apple Pay'];
      html = html.replace(/@ICON/g, 'logoApplePay');
      break;
    case paymentOptionIDs$6.card:
      paymentSource = this.strings.Card;
      html = html.replace(/@ICON/g, 'iconCardFront');
      html = html.replace(/@CLASSNAME/g, 'braintree-icon--bordered');
      break;
    case paymentOptionIDs$6.googlePay:
      paymentSource = this.strings['Google Pay'];
      html = html.replace(/@ICON/g, 'logoGooglePay');
      break;
    case paymentOptionIDs$6.paypal:
      paymentSource = this.strings.PayPal;
      html = html.replace(/@ICON/g, 'logoPayPal');
      break;
    case paymentOptionIDs$6.paypalCredit:
      paymentSource = this.strings['PayPal Credit'];
      html = html.replace(/@ICON/g, 'logoPayPalCredit');
      break;
    case paymentOptionIDs$6.venmo:
  ...
  addSelectionEventHandler_1(div, clickHandler);
...
var paymentMethodTypes$1 = constants.paymentMethodTypes;
...
DeleteConfirmationView.prototype._initialize = function () {
  ...
  addSelectionEventHandler_1(this._yesButton, function () {
    this.model.deleteVaultedPaymentMethod();
  }.bind(this));
  addSelectionEventHandler_1(this._noButton, function () {
...
DeleteConfirmationView.prototype.applyPaymentMethod = function (paymentMethod) {
  ...
  if (messageText) {
    switch (paymentMethod.type) {
      case paymentMethodTypes$1.card:
        ...
        break;
      case paymentMethodTypes$1.paypal:
        identifier = paymentMethod.details.email;
        break;
      case paymentMethodTypes$1.venmo:
...
var deleteConfirmationView = DeleteConfirmationView;
...
var analyticsKinds = constants.analyticsKinds;
...
var CHANGE_ACTIVE_PAYMENT_METHOD_TIMEOUT = constants.CHANGE_ACTIVE_PAYMENT_METHOD_TIMEOUT;
var DEVELOPER_MISCONFIGURATION_MESSAGE = constants.errors.DEVELOPER_MISCONFIGURATION_MESSAGE;
...
MainView.prototype._initialize = function () {
  ...
  this.paymentSheetViewIDs = Object.keys(paymentSheetViews).reduce(function (ids, sheetViewKey) {
    var PaymentSheetView, paymentSheetView;

    if (this.model.supportedPaymentOptions.indexOf(sheetViewKey) !== -1) {
      PaymentSheetView = paymentSheetViews[sheetViewKey];
  ...
  addSelectionEventHandler_1(this.toggle, this.toggleAdditionalOptions.bind(this));
  ...
  if (this._hasMultiplePaymentOptions) {
    paymentOptionsView$1 = new paymentOptionsView({
      client: this.client,
    ...
    this.addView(paymentOptionsView$1);
  }
...
MainView.prototype.requestPaymentMethod = function () {
  ...
  return activePaymentView.requestPaymentMethod().then(function (payload) {
    analytics$1.sendEvent(this.client, 'request-payment-method.' + analyticsKinds[payload.type]);

    return payload;
  }.bind(this)).catch(function (err) {
    analytics$1.sendEvent(this.client, 'request-payment-method.error');

    return promise$2.reject(err);
  }.bind(this));
};
...
MainView.prototype.showSheetError = function (error) {
  ...
  if (this.strings.hasOwnProperty(error)) {
    ...
    errorMessage = this.strings[snakeCaseToCamelCase$1(error.code) + 'Error'] || genericErrorMessage;
...
MainView.prototype.teardown = function () {
  ...
  return promise$2.all(teardownPromises).then(function () {
    if (error) {
...
MainView.prototype._sendToDefaultView = function () {
  ...
  if (paymentMethods.length > 0) {
    if (preselectVaultedPaymentMethod) {
      analytics$1.sendEvent(this.client, 'vaulted-card.preselect');
...
function snakeCaseToCamelCase$1(s) {
...
DataCollector.prototype.initialize = function () {
  ...
  return promise$2.resolve().then(function () {
    ...
    if (commonjsGlobal.braintree && commonjsGlobal.braintree.dataCollector) {
      return promise$2.resolve();
    }
    ...
    return commonjsGlobal.braintree.dataCollector.create(self._config);
  }).then(function (instance) {
    self._instance = instance;
  }).catch(function (err) {
    analytics$1.sendEvent(self._config.client, 'data-collector.setup-failed');
...
var events$2 = enumerate_1([
  'AUTHENTICATION_COMPLETE'
], 'threedsecure:');

var assign$k = assign$1.assign;
...
var INTEGRATION_TIMEOUT_MS$1 = constants$2.INTEGRATION_TIMEOUT_MS;

var PLATFORM$1 = constants$2.PLATFORM;
var VERSION$e = "3.52.0";
...
function ThreeDSecure(options) {
  this._options = options;
  this._assetsUrl = options.client.getConfiguration().gatewayConfiguration.assetsUrl + '/web/' + VERSION$e;
  this._isDebug = options.client.getConfiguration().isDebug;
  this._client = options.client;
  this._clientMetadata = {
    sdkVersion: PLATFORM$1 + '/' + VERSION$e,
...
ThreeDSecure.prototype.verifyCard = function (options) {
  ...
  if (this._usesSongbirdFlow()) {
    onLookupComplete = deferred$1(options.onLookupComplete);
    ...
    promise$1 = this._prepareRawLookup(data).then(function (transformedData) {
      data = transformedData;
    });
  } else {
    addFrame = deferred$1(options.addFrame);
    removeFrame = deferred$1(options.removeFrame);
  ...
  return promise$1.then(function () {
    ...
    return self._client.request({
      ...
      if (status === 404) {
        lookupError = errors$a.THREEDS_LOOKUP_TOKENIZED_CARD_NOT_FOUND_ERROR;
        analyticsMessage += '.404';
      } else if (status === 422) {
        lookupError = errors$a.THREEDS_LOOKUP_VALIDATION_ERROR;
        analyticsMessage += '.422';
      } else {
        lookupError = errors$a.THREEDS_LOOKUP_ERROR;
      }
...
ThreeDSecure.prototype._checkForVerifyCardError = function (options) {
  ...
  if (this._verifyCardBlockingError) {
    ...
    return new braintreeError(errors$a.THREEDS_AUTHENTICATION_IN_PROGRESS);
  ...
  if (errorOption) {
    return new braintreeError({
      type: errors$a.THREEDS_MISSING_VERIFY_CARD_OPTION.type,
      code: errors$a.THREEDS_MISSING_VERIFY_CARD_OPTION.code,
...
ThreeDSecure.prototype._prepareRawLookup = function (options) {
  ...
  return this._getDfReferenceId().then(function (id) {
    ...
    data.braintreeLibraryVersion = 'braintree/web/' + VERSION$e;
...
ThreeDSecure.prototype._triggerCardinalBinProcess = function (bin) {
  ...
  return commonjsGlobal.Cardinal.trigger('bin.process', bin).then(function (binResults) {
...
ThreeDSecure.prototype.cancelVerifyCard = function () {
  ...
  if (!this._lookupPaymentMethod) {
    return promise.reject(new braintreeError(errors$a.THREEDS_NO_VERIFICATION_PAYLOAD));
  }

  response = assign$k({}, this._lookupPaymentMethod, {
  ...
  if (this._usesSongbirdFlow() && this._verifyCardCallback) {
    this._verifyCardCallback(new braintreeError(errors$a.THREEDS_VERIFY_CARD_CANCELED_BY_MERCHANT));
  }
  ...
  options.onLookupComplete(lookupResponse, function () {
    ...
    if (challengePresented) {
      if (self._usesSongbirdFlow()) {
        ...
        commonjsGlobal.Cardinal.continue('cca',
          {
...
ThreeDSecure.prototype._createIframe = function (options) {
  ...
  this._bus.on(bus_1.events.CONFIGURATION_REQUEST, function (reply) {
    reply({
      acsUrl: response.acsUrl,
      pareq: response.pareq,
      termUrl: response.termUrl + '&three_d_secure_version=' + VERSION$e + '&authentication_complete_base_url=' + encodeURIComponent(authenticationCompleteBaseUrl),
      md: response.md,
      parentUrl: parentURL
    });
  });

  this._bus.on(events$2.AUTHENTICATION_COMPLETE, function (data) {
    this._handleAuthResponse(data, options);
  }.bind(this));

  url = this._assetsUrl + '/html/three-d-secure-bank-frame' + useMin_1(this._isDebug) + '.html?showLoader=' + options.showLoader;

  this._bankIframe = iframer({
    src: url,
    height: IFRAME_HEIGHT,
    width: IFRAME_WIDTH,
    name: constants$6.LANDING_FRAME_NAME + '_' + this._bus.channel,
...
ThreeDSecure.prototype.teardown = function () {
  ...
  if (commonjsGlobal.Cardinal) {
    commonjsGlobal.Cardinal.off('payments.setupComplete');
    commonjsGlobal.Cardinal.off('payments.validated');
  }
...
ThreeDSecure.prototype._createPaymentsSetupCompleteCallback = function (resolve, timeoutReference) {
  ...
  return function (data) {
    ...
    commonjsGlobal.clearTimeout(timeoutReference);
    ...
    switch (data.ActionCode) {
      ...
      case 'ERROR':
        switch (data.ErrorNumber) {
          case 10001:
          case 10002:
            formattedError = new braintreeError(errors$a.THREEDS_CARDINAL_SDK_SETUP_TIMEDOUT);
            break;
          case 10003:
          case 10007:
          case 10009:
            formattedError = new braintreeError(errors$a.THREEDS_CARDINAL_SDK_RESPONSE_TIMEDOUT);
            break;
          case 10005:
          case 10006:
            formattedError = new braintreeError(errors$a.THREEDS_CARDINAL_SDK_BAD_CONFIG);
            break;
          case 10008:
          case 10010:
            formattedError = new braintreeError(errors$a.THREEDS_CARDINAL_SDK_BAD_JWT);
            break;
          case 10011:
            analytics.sendEvent(self._options.client, 'three-d-secure.verification-flow.canceled');
            formattedError = new braintreeError(errors$a.THREEDS_CARDINAL_SDK_CANCELED);
            break;
          case 10004:
          case 10012:
          default:
            formattedError = new braintreeError(errors$a.THREEDS_CARDINAL_SDK_ERROR);
        }
...
ThreeDSecure.prototype._setupSongbird = function (setupOptions) {
  var self = this;
  var scriptSource = constants$6.CARDINAL_SCRIPT_SOURCE.sandbox;
  ...
  return new promise(function (resolve, reject) {
    var timeoutReference = commonjsGlobal.setTimeout(function () {
      analytics.sendEvent(self._client, 'three-d-secure.cardinal-sdk.init.setup-timeout');
      reject(new braintreeError(errors$a.THREEDS_CARDINAL_SDK_SETUP_TIMEDOUT));
    }, setupOptions.timeout || INTEGRATION_TIMEOUT_MS$1);

    if (setupOptions.isProduction) {
      scriptSource = constants$6.CARDINAL_SCRIPT_SOURCE.production;
    }
    assets.loadScript({src: scriptSource}).catch(function (err) {
      return promise.reject(convertToBraintreeError_1(err, errors$a.THREEDS_CARDINAL_SDK_SCRIPT_LOAD_FAILED));
    }).then(function (script) {
      self._cardinalScript = script;
      commonjsGlobal.Cardinal.on('payments.setupComplete', self._createPaymentsSetupCompleteCallback(resolve, timeoutReference));

      if (setupOptions.loggingEnabled) {
        commonjsGlobal.Cardinal.configure({
          logging: {
            level: 'verbose'
          }
        });
      ...
      commonjsGlobal.Cardinal.setup('init', {
        jwt: jwt
      });

      self._clientMetadata.cardinalDeviceDataCollectionTimeElapsed = Date.now() - startTime;

      commonjsGlobal.Cardinal.on('payments.validated', self._createPaymentsValidatedCallback());
    }).catch(function (err) {
      var error = convertToBraintreeError_1(err, {
        type: errors$a.THREEDS_CARDINAL_SDK_SETUP_FAILED.type,
        code: errors$a.THREEDS_CARDINAL_SDK_SETUP_FAILED.code,
        message: errors$a.THREEDS_CARDINAL_SDK_SETUP_FAILED.message
      });
...
ThreeDSecure.prototype._performJWTValidation = function (jwt) {
  ...
  return this._client.request({
    ...
    var error = new braintreeError({
      type: errors$a.THREEDS_JWT_AUTHENTICATION_FAILED.type,
      code: errors$a.THREEDS_JWT_AUTHENTICATION_FAILED.code,
      message: errors$a.THREEDS_JWT_AUTHENTICATION_FAILED.message,
      details: {
        originalError: err
      }
    });
...
var threeDSecure = wrapPromise_1.wrapPrototype(ThreeDSecure);

function isHTTPS$1(protocol) {
  protocol = protocol || commonjsGlobal.location.protocol;
...
var isHTTPS$2 = isHttps$1.isHTTPS;
...
function create$7(options) {
  ...
  return basicComponentVerification_1.verify({
    ...
    if (!gwConfig.threeDSecureEnabled) {
      error = errors$a.THREEDS_NOT_ENABLED;
    }

    if (config.authorizationType === 'TOKENIZATION_KEY') {
      error = errors$a.THREEDS_CAN_NOT_USE_TOKENIZATION_KEY;
    }

    isProduction = gwConfig.environment === 'production';

    if (isProduction && !isHTTPS$2()) {
      error = errors$a.THREEDS_HTTPS_REQUIRED;
    }
    ...
    if (options.version === 2 && !(gwConfig.threeDSecure && gwConfig.threeDSecure.cardinalAuthenticationJWT)) {
      ...
      error = errors$a.THREEDS_NOT_ENABLED_FOR_V2;
    }
...
var assign$l = assign.assign;


var DEFAULT_ACS_WINDOW_SIZE = '03';

function ThreeDSecure$1(client, merchantConfiguration) {
  this._client = client;
...
ThreeDSecure$1.prototype.verify = function (payload, merchantProvidedData) {
  var verifyOptions = assign$l({
...
ThreeDSecure$1.prototype.updateConfiguration = function (key, value) {
...
var paymentMethodsViewID = paymentMethodsView.ID;
var paymentOptionsViewID = paymentOptionsView.ID;
var paymentOptionIDs$7 = constants.paymentOptionIDs;
var translations$2 = translations.translations;
...
var wrapPrototype = wrapPromise_1.wrapPrototype;
...
var UPDATABLE_CONFIGURATION_OPTIONS = [
  paymentOptionIDs$7.paypal,
  paymentOptionIDs$7.paypalCredit,
  paymentOptionIDs$7.applePay,
  paymentOptionIDs$7.googlePay,
  'threeDSecure'
];
...
Dropin.prototype._initialize = function (callback) {
  ...
  if (!container) {
    analytics$1.sendEvent(self._client, 'configuration-error');
  ...
  // Backfill with `en`
  self._strings = assign$m({}, translations$2.en);
  if (self._merchantConfiguration.locale) {
    localizedStrings = translations$2[self._merchantConfiguration.locale] || translations$2[self._merchantConfiguration.locale.split('_')[0]];
    // Fill `strings` with `localizedStrings` that may exist
    self._strings = assign$m(self._strings, localizedStrings);
  }
  ...
  self._model.initialize().then(function () {
    self._model.on('cancelInitialization', function (err) {
      ...
      analytics$1.sendEvent(self._client, 'load-error');
      callback(err);
    });

    self._model.on('asyncDependenciesReady', function () {
      if (self._model.dependencySuccessCount >= 1) {
        analytics$1.sendEvent(self._client, 'appeared');
...
Dropin.prototype._setUpDataCollector = function () {
  var self = this;
  var config = assign$m({}, self._merchantConfiguration.dataCollector, {client: self._client});
...
Dropin.prototype._setUpThreeDSecure = function () {
  var self = this;
  var config = assign$m({}, this._merchantConfiguration.threeDSecure);

  this._model.asyncDependencyStarting();

  this._threeDSecure = new threeDSecure_1(this._client, config);
...
Dropin.prototype._sendVaultedPaymentMethodAppearAnalyticsEvents = function () {
  ...
  for (i = 0; i < paymentMethods.length; i++) {
    ...
    analytics$1.sendEvent(this._client, 'vaulted-' + constants.analyticsKinds[type] + '.appear');
  }
};
...
Dropin.prototype.requestPaymentMethod = function (options) {
  ...
  return this._mainView.requestPaymentMethod().then(function (payload) {
    ...
    return formatPaymentMethodPayload$1(payload);
  });
};
...
Dropin.prototype._injectStylesheet = function () {
  ...
  stylesheetUrl = assetsUrl + '/web/dropin/' + VERSION$g + '/css/dropin.css';

  assetLoader.loadStylesheet({
    href: stylesheetUrl,
...
Dropin.prototype.teardown = function () {
  ...
  return promise.then(function () {
    ...
    if (teardownError) {
      return promise$2.reject(teardownError);
    }
...
function formatPaymentMethodPayload$1(paymentMethod) {
  var formattedPaymentMethod = {
    nonce: paymentMethod.nonce,
    details: paymentMethod.details,
    type: paymentMethod.type
...
var dropin = wrapPrototype(Dropin);
...
var kebabCaseToCamelCase_1 = kebabCaseToCamelCase;
...
function addCompositeKeyValuePairToObject(obj, key, value) {
  ...
  var topLevelKey = kebabCaseToCamelCase_1(decomposedKeys[0]);
...
function createFromScriptTag(createFunction, scriptTag) {
  ...
  container.id = 'braintree-dropin-' + uuid_1$1();

  form = findParentForm_1.findParentForm(scriptTag);
  ...
  createFunction(createOptions).then(function (instance) {
    analytics$1.sendEvent(instance._client, 'integration-type.script-tag');
...
var createFromScriptTag_1 = createFromScriptTag;
...
function create$8(options) {
  if (!options.authorization) {
    return promise$2.reject(new dropinError('options.authorization is required.'));
  }

  return client$1.create({
    authorization: options.authorization
  }).catch(function (err) {
    return promise$2.reject(new dropinError({
    ...
    if (clientInstance.getConfiguration().authorizationType === 'TOKENIZATION_KEY') {
      analytics$1.sendEvent(clientInstance, 'started.tokenization-key');
    } else {
      analytics$1.sendEvent(clientInstance, 'started.client-token');
    }
...
function setAnalyticsIntegration(clientInstance) {
  ...
  configuration.analyticsMetadata.dropinVersion = VERSION$h;
...
createFromScriptTag_1(create$8, typeof document !== 'undefined' && document.querySelector('script[data-braintree-dropin-authorization]'));

var braintreeWebDropIn = {
  create: wrapPromise_1(create$8),
  /**
...
export { braintreeWebDropIn as braintree };
